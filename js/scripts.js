...
document.getElementById('contact-form').addEventListener('submit', function(e) {
  ...
  console.log('Data yang dikirim:', data); // Tambahkan logging
  ...
  .then(response => {
    console.log('Status respons:', response.status); // Tambahkan logging
    return response.json();
  })
  .then(data => {
    console.log('Data respons:', data); // Tambahkan logging
